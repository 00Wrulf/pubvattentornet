    ...
    return(
        <div className="content">
            ...
            <div className="pubInfo">
                ...
                <p>Pub Vattentornet är Norrköpings äldsta studentpub. Sedan 2002 serverar Vattentornets Boråd finöl till studentpriser.</p>

                <h2>Våra lokaler</h2>
                <p>Pub Vattentornet har den stora äran att vara inrymd inuti ett av Sveriges äldsta bevarade vattentorn! Tornet byggdes i början av 1900-talet och ägs idag av HSB, vilka också har haft vänligheten att bistå oss med lokalerna.
                ...
                Våra fantastiska lokaler går alldeles utmärkt att boka! Här nedan kan du läsa lite vad som gäller kring en bokning. När du gjort det kan du kika in på bokningssidan och se vilka datum som är lediga.</p>
                <h2>Bokning av allrum</h2>
                <p>Bokning av allrummet är endast till för boende i vattentornet. För att boka allrummet behöver vi ditt lägenhetsnummer i tornet samt en beskrivning av vad lokalerna skall användas till.
                ...
                Sop och mopp finns i allrummets städskåp. Städskåpet finns i hörnet mot puben.</p>

                <h2>Utlåning för boende</h2>
                <p>Boende i vattentornet kan låna följande saker av borådet.

                Projektor samt projektorduk
                Två biljardköer, bollar samt triangel
                Borrmaskin med 103 bits och borrar</p>
                </div>
