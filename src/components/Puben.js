    ...
    <div className='content'>
      <div id='about'>
        <div className='pubInfo'>
          <ul>
            <div id='info'>
              <div class='clicker' tabIndex='1'>Om Vattentornet</div>
              <div class='hiddendiv'>
                <p>Pub Vattentornet är Norrköpings äldsta studentpub. Sedan 2002 har det serverats finöl till studentpriser, med ett tillskott av diverse sprit såsom whisky, rom, och gin.</p>
              </div>
            </div>
            <div id='info'>
              <div class='clicker' tabIndex='1'>Våra lokaler</div>
              <div class='hiddendiv'>
