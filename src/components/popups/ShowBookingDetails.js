...
export default function BookingDetails ({ selectedBooking, closePopup }) {
  ...
  const onSubmit = (data) => {
    ...
    if (editForm) {
      const bookpub = !!data.bookpub // Ful-lösning för att få en unchecked checkbox att vara 'false' och inte undefined
      ...
      <div className='popup'>
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <label>
                Datum *
            <input
              type='text' placeholder='Önskat datum' disabled={!editForm}
              {...register('date', {
          ...
          <label>
                Mail *
            <input
              type='email' placeholder='Din epostadress' disabled={!editForm}
              {...register('email', {
          ...
          <label>
                Ditt namn *
            <input
              type='text' placeholder='För- och efternamn' disabled={!editForm}
              {...register('name', {
          ...
          <label>
                Lägenhetsnummer
            <input
              type='text' placeholder='Ditt lägenhetsnummer' disabled={!editForm}
          ...
          <label>
                Beskrivning *
            <input
              type='text' placeholder='Vad skall du göra? Hur många är ni? Vilka är ni?' disabled={!editForm}
          ...
          <label>
            ...
            <input
              type='checkbox' disabled={!editForm} defaultChecked={selectedBooking.bookpub}
